...
\label{sec:reaults_ranking}
	...
	\begin{table}[h]
		\centering
		\includegraphics[width=12cm]{web_t_rating_results.png}
	...
	%	\caption{The Twitter tweet T-ranking comparison against Elo ranking.}
...
\label{sec:reaults_NLP}
	...
	\begin{table}[h]
		\centering
		\includegraphics[width=12cm]{top_10_sim_NER.png}
